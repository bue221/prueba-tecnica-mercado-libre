      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="mt-10 border-t border-gray-100 pt-6 text-center text-xs text-gray-500">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 mt-6">
            <div>
              <img src="/img/footer_1.png" alt="Industria y Comercio Superintendencia" className="h-6" />
            </div>
            <div>
              <img src="/img/footer_2.png" alt="Industria y Comercio Superintendencia" className="h-6" />
            </div>
          </div>
        </div>
      </div>
